...
export default class TourGuideProfile extends React.Component {
  ...
  render() {
    // const { getTourGuide } = this.context;
    // const tourguide = getTourGuide(this.state.slug);
    ...
    return (
      <>
        <div
          style={{
            height: "300px",
            backgroundImage: 'url("../Assets/Images/lagan.jpg")',
          }}
          class="jumbotron m-0 p-0"
        >
          <div class="container m-0 p-0">
            <div
              style={{ width: "860px" }}
              className="row h-100 p-t-20 d-flex align-items-center"
            >
              <div className="col-lg-4 m-l-100 m-t-120">
                <img
                  src={profile}
                  className="border rounded float-left"
                  alt="..."
                />
              </div>
